...
##https://github.com/randombit/botan/archive/2.17.3.tar.gz
set -e
set -x

wget https://github.com/randombit/botan/archive/2.17.3.tar.gz
script_dir=$(readlink -f $(dirname $0))
botan_archive=2.17.3.tar.gz
botan_extracted_dir_name=botan-2.17.3

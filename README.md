...
A simple text editor named "CryptoPad" can be useful for send encrypted text by email. Cryptopad always use triple encryption with this algorithms.
...
- the output is encrypted with key3 by Serpent/GCM with key2 and nonce 3
...
([XChaCha20Poly1305](https://botan.randombit.net/handbook/api_ref/cipher_modes.html#chacha20poly1305), [AES256](https://en.wikipedia.org/wiki/Advanced_Encryption_Standard)/[EAX](https://en.wikipedia.org/wiki/EAX_mode), or [Serpent](https://en.wikipedia.org/wiki/Serpent_(cipher))/[GCM](https://en.wikipedia.org/wiki/Galois/Counter_Mode))

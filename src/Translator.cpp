...
void Translator::installTranslators()
{
    ...
    // Works for both a system install (bin/arsenic → ../share/arsenic/languages)
    // and an AppImage (AppDir/usr/bin/arsenic → ../share/arsenic/languages).
    path = QApplication::applicationDirPath() + "/../share/arsenic/languages";
#else
    // Windows: languages/ next to arsenic.exe
    // macOS:   languages/ next to the binary inside the .app bundle
    path = QApplication::applicationDirPath() + "/languages";
#endif

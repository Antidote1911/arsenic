...
typedef std::unique_ptr<FileSystemModel> FileSystemModelPtr;
...
namespace FileSystemModelPublic
{
...
public:
    ...
    FileSystemModelPtr cloneByValue() const;
...
protected:
    ...
    std::vector<FileInfoPtr> file_list;
};

#endif // FILESYSTEMMODEL

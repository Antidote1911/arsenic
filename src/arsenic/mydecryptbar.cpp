    ...
    &arg_password,bool delete_success) : MyAbstractBar(parent), ptr_model(arg_ptr_model)
{
    ...
    connect(worker_thread, &MyDecryptThread::updateProgress, this, &MyAbstractBar::updateProgress);
    connect(worker_thread, &MyDecryptThread::updateGeneralProgress, this, &MyAbstractBar::updateGeneralProgress);

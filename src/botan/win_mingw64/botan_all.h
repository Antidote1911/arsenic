...
* 'configure.py --minimized-build --amalgamation --cc=gcc --cpu=x86_64 --os=mingw --disable-shared --enable-modules=aes,aes_ni,aes_vperm,serpent,serpent_avx2,serpent_simd,gcm,crc24,crc32,sm2,sm3,sm4,gost_3411,keccak,sha1,sha1_sse2,sha1_x86,tiger,adler32,aead,argon2,auto_rng,md4,md5,rmd160,sha2_32_x86,sha2_64,sha2_64_bmi2,sha3,sha3_bmi2,shacal2,shacal2_avx2,shacal2_simd,shacal2_x86,shake,skein,sodium,streebog,system_rng,whirlpool'
*
* Target
